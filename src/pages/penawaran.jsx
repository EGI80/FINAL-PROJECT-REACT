    ...
    return (
        <div className="penawaran-deals">
            <div className="penawaran-top">
                ...
                <div className="shadow-sm p-3 mb-5 bg-white rounded penawaran-form card border-dark">
            ...
            <div className="penawaran-mid">
                <div className="p-3 mb-3">
                    <div className="penawaran-card-header">
                        <img className="penawaran-card-img-top" src="./img/1Tanjunlesun.jpg" alt="Card image cap"/>
                    </div>
                    <div className="card-body">
                        <div className="shadow p-3 bg-white rounded">
                            <h2 className="penawaran-card-title">Tanjung Lesung</h2>
